...
{
    public class en_AccountController : Controller
    {
        ...
        public en_AccountController(UserManager<ApplicationUser> userManager,SignInManager<ApplicationUser> SignInManager,
                ...
                if(result.Succeeded){
                    ...
                    if(user != null){
                        if(!string.IsNullOrEmpty(returnUrl) && Url.IsLocalUrl(returnUrl) ){
                            ...
                            return RedirectToAction("Welcome","en_Student");
        ...
        public async Task<IActionResult> Logout()
        {
           ...
           return RedirectToAction("Index","en_Home");
        ...
        public IActionResult Register()
        {
            if(this._signInManager.IsSignedIn(User)){
                return RedirectToAction("Apply","en_Account");
            }
            return View();            
        }
