...
{
    public class en_PaymentController : Controller
    {
        ...
        public en_PaymentController(BimEduDataContext datacontext,IConfiguration conf,IHostingEnvironment environment,
