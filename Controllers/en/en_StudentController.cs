...
namespace bim_edu.Controllers
{
    ...
    [Authorize]
    public class en_StudentController : Controller
    {
        ...
        public en_StudentController(UserManager<ApplicationUser> userManager,SignInManager<ApplicationUser> signInManager, 
